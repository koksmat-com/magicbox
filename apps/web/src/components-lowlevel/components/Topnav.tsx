...
import { NavigationNode, NexiNavConfig } from '../helpers';
            ...
            >
                ...
                {showLevel2 &&
                    <div
                        ...
                        <SubNavigation selectParent={()=>{}} node={selectedNavigationNode} onNavigate={() => { setShowLevel2(false); }} level={2} /></div>}
